...
var ANRDF=1;
var ANSCC="unescape(isSocialNetworkShared()+document.referrer+searchLogger(aolTacRef(), document.referrer, '/search/([^\#\?]+)')).toLowerCase()";
var ANTPUD;
var ANVDT=0;
...
function searchLogger(ref,site,sitesearch){
var ANSTC=function(ref,site,sitesearch){
var kw=false;
try{
...
CMKW=ANSTC(ref,site,sitesearch);
...
ustr+="ifu="+encodeURIComponent(document.referrer)+"&cmmiss="+encodeURIComponent(c)+"&cmkw="+encodeURIComponent(kw);
return encodeURIComponent(ustr);
}else{
